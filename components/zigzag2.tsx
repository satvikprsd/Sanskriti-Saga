...
import FeatImage01 from '@/public/images/features-03-image-04.jpg'
import FeatImage02 from '@/public/images/features-03-image-05.jpg'
import FeatImage03 from '@/public/images/features-03-image-06.jpg'
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  <h3 className="h3 mb-3">Chattisgarh</h3>
                  <p className="text-xl text-gray-400 mb-4">As you step into Chattisgarh, you will start seeing glimpses of handicraft items. The state has earned fame for its mastery in bell metal handicraft, bamboo craft, clay art, godna art, wrought iron craft, cowrie craft, Kosa, etc. These items are an excellent choice for decorating your house.</p>
                  <ul className="text-lg text-gray-400 -mb-2">
                    <li className="flex items-center mb-2">
                      <svg className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
